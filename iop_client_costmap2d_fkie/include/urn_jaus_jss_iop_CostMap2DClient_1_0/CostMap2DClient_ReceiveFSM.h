...
#include "urn_jaus_jss_iop_CostMap2DClient_1_0/Messages/MessageSet.h"
#include "urn_jaus_jss_iop_CostMap2DClient_1_0/InternalEvents/InternalEventsSet.h"
...
{
public:
	CostMap2DClient_ReceiveFSM(urn_jaus_jss_core_Transport_1_0::Transport_ReceiveFSM* pTransport_ReceiveFSM, urn_jaus_jss_core_EventsClient_1_0::EventsClient_ReceiveFSM* pEventsClient_ReceiveFSM, urn_jaus_jss_core_AccessControlClient_1_0::AccessControlClient_ReceiveFSM* pAccessControlClient_ReceiveFSM);
...
protected:
	...
	urn_jaus_jss_iop_CostMap2DClient_1_0::QueryCostMap2D p_query_costmap2d_msg;

	void pAccessStateHandler(JausAddress &address, unsigned char code);
	void pHandleEventReportMap(Receive::Body::ReceiveRec &transport_data, urn_jaus_jss_core_EventsClient_1_0::Event &msg);
