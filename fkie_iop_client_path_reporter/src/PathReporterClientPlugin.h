...
#ifndef PATHREPORTERCLIENTPLUGIN_H
#define PATHREPORTERCLIENTPLUGIN_H

#include "urn_jaus_jss_iop_PathReporterClient/PathReporterClientService.h"
...
class DllExport PathReporterClientPlugin : public PluginInterface
{
public:
	PathReporterClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_iop_PathReporterClient::PathReporterClientService *p_my_service;
